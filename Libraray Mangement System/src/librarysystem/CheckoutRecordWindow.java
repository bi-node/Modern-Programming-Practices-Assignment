...
public class CheckoutRecordWindow extends JFrame implements ActionListener {
	...
	public void actionPerformed(ActionEvent ae) {
		...
		book = ci.getAllBooks().get(isbnNo);
		...
		if (ae.getSource() == btnCheck) {
			...
			if (checkRecord) {
				...
				if(!book.isAvailable())
				{
					JOptionPane.showMessageDialog(null, "No available copies of book");
				}
	...
	public void listOutBooks(Book book) {
		...
		String[] rowData = { book.getIsbn(), book.getTitle(), "" + book.getNumCopies(),
